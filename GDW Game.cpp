...
int combat(int role, int sword, int healthpotion, int health, int maxhealth, int monHealth, int monDamage) {
    ...
    while (monHealth > 0 || health > 0) {
        ...
        std:: cout << "your health is currently" << health;
        std:: cout << "the monsters health is currently" << monHealth;
        std:: cout << "press a button and then enter to roll for damage\n";
        ...
        if (monHealth <= 0) {
            std:: cout << "Congratulations you have slain the fearsome Ammit!\n You have been rewarded with the lions tail belt of JUSTICE!!!!!!";
        }
        else if (monhealth >= 1) {
            ...
            if (health >= 1) {
                std::cout << "The monster liked your cut and dealt " << monDamage << " damage. \n"
                    if (healthpotion == 1) { //loop to use a health potion
                        ...
                        std::cout << "You have a health potion would you like to use it and restore 10 health. Enter 1 for yes and 0 for no: " << endl;
                        cin >> usePotion;
    ...
    ~- ~ ~ - -~ ~ -..    ..- .  -.``--.._
     -~ ~- ~ ~-~ ~ -~ ~~-~ -.  -.  -. -.`--.._.--''. ~ -~_
         ~~ -~_-~ _~- _~~ _~-_~ ~-_~~ ~-.___    -._  -.   . . ~ -~
            ...
            int monHealth = 10;
            int monDamage = 6;
            health = combat(role, sword, healthpotion, health, maxhealth, monHealth, monDamage);
